...
public class MapImmutableExample 
{
    ...
    public static void main(String[] args) throws NumberFormatException,IOException
    {
        ...
        Student one = new Student(1, "Mahesh1"); // key1
        Student two = new Student(2, "Mahesh2"); // key2
        // put keys in map
        map.put(one, one.getname());
        map.put(two, two.getname());
        // changing key state so that
        // hashcode() should be calculated again
        one.setname("Not Mahesh1");
        two.setname("Not Mahesh2");
        System.out.println("One HashCode: "+one.hashCode());
        System.out.println("Two HashCode: "+two.hashCode());
        // still prints Mahesh1
        System.out.println("After Set: "+map.get(one));
        // still prints Mahesh1
        System.out.println("After Set: "+map.get(two));
        System.out.println("One HashCode: "+one.hashCode());
        System.out.println("Two HashCode: "+two.hashCode());
        // try with newly created key with same Rollno
        Student three = new Student(1, "Geeks3");
        // we get Mahesh1
        System.out.println("After New Key with Same Roll No: "+map.get(three));
